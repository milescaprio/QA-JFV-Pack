...
tellraw @s[scores={respawntimer=162}] {"text":"Teleporting to Respawn Point!","color":"dark_purple"}
execute as @s[scores={respawntimer=158}] run gamerule keepInventory true 
execute as @s[scores={respawntimer=158}] run gamerule doImmediateRespawn true
kill @s[scores={respawntimer=154}]
